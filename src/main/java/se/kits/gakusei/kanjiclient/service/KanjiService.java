...
public class KanjiService {
    ...
    //private static final String REST_SERVICE_URI = "https://staging.daigaku.se/api";
    ...
    public String getQuestion(String lessonName){
        try {
            ...
            return formatQuestion(responseEntity.getBody().substring(
    ...
    private String formatQuestion(String question){
        ...
        return "Kanji nugget id: " + currentQuestionId
                + "\nKanji: " + question.substring(question.indexOf("[\""), question.indexOf("],"));
    }
